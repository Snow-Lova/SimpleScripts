...
-- Number of times to loop through the teleport locations
local loopCount = 3

-- Loop through all locations for the specified number of times
for i = 1, loopCount do
    print(string.format("Starting loop %d of %d", i, loopCount))
